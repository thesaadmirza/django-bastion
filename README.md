...
> **Status: alpha, version 0.0.1a1.** The API can change in any later version, patch releases included,
...
`--pre` is not optional: 0.0.1a1 is a pre-release, and pip skips those unless asked.
