...
> **Status: alpha, version 0.0.1a4.** The API can change in any later version, patch releases included,
...
`--pre` is not optional: 0.0.1a4 is a pre-release, and pip skips those unless asked.
